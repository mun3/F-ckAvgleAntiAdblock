...
#### Note: Maintenance effort will be gradually reduced due to work commitments. From now on, patches will be released only when donation target (0.02 Bitcoin) is reached: ####
